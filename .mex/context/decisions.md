...
AdvancedCore is shaded/consumed by VotingPlugin. Public user/reward changes affect its vote path even when this repository's own tests pass; check the current consumer source and dependency version before changing a contract. Source: `AdvancedCore/pom.xml`, `/root/dev/AGENTS.md`.
